...
<body>
    ...
    <center><div class="btn"><i class="fa fa-gavel fa-2x">   My Profile</i></div></center>
    </div>
...
<br><br><br><br><br><br>
    Company/Store Label:<br> <input type="text" name="name">
    ...
    Bank Account's Number: <br><input type="text" name="name">
    <span class="error">* </span></br>
    
    Buisness Documents: <br><input type="text" name="name">
    <span class="error">* </span></br>
    
    Description: <br><textarea name="comment" rows="5" cols="40"></textarea></br>
    
    Socila Media: <br><input type="text" name="name"></br>
